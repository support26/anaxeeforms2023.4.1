...
module.exports = (service, endpoint) => {
  ...
  const sendDataToAirtable = async(partial,saved, form) => {
    try {
    const sendingData = {
      ...
      "data" : partial.xml.toString()
    }
    console.log("sendingData---------", sendingData, '\n');
    const result = await  axios.post("https://android-mapping-backend.el.r.appspot.com/forms/formWebhookRouter", sendingData);
